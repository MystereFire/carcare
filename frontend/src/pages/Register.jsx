            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border-gray-300 pl-10 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  value={form.password}
                  onChange={handleChange}
                  className="w-full rounded-lg border-gray-300 pl-10 pr-10 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                />
                <button
                  type="button"
